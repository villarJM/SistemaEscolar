            ...
            <nav class="sb-sidenav accordion" style="background-color: #e3f2fd;" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="registrar_profesores.php">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus"></i></div>
                            Profesores
                        </a>
                        <a class="nav-link" href="registrar_materia.php">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus"></i></div>
                            Materias
                        </a>
                        ...
                        <a class="nav-link" href="registrar_grupo.php">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus"></i></div>
                            Grupos
                        </a>
                        ...
                        <a class="nav-link" href="registrar_carreras.php">
                            <div class="sb-nav-link-icon"><i class="fa fa-plus"></i></div>
                            Carreras
                        </a>
