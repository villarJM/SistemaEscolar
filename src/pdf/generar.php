...
$pdf->SetTitle("Lista de Carreras");
...
//$datosC = mysqli_fetch_assoc($carreras);
...
$pdf->Cell(196, 5, "Datos de la Carrera", 1, 1, 'C', 1);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(90, 5, utf8_decode('ID'), 1, 0, 'L');
$pdf->Cell(80, 5, utf8_decode('Carrera'), 1, 0, 'L');
$pdf->Cell(26, 5, utf8_decode('Estado'), 1, 1, 'L');
$pdf->SetFont('Arial', '', 10);
while($datosC = mysqli_fetch_assoc($carreras)){
    $pdf->Cell(90, 5, utf8_decode($datosC['idmatricula']), 1, 0, 'L');
    $pdf->Cell(80, 5, utf8_decode($datosC['carrera']), 1, 0, 'L');
    if($datosC['estado'] == 1){
        $pdf->Cell(26, 5, utf8_decode('Activo'), 1, 1, 'L');
    } else {
        $pdf->Cell(26, 5, utf8_decode('Inactivo'), 1, 1, 'L');
    }
}
